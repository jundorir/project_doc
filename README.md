...
Documentation for the [New Bee Swarm Client](https://github.com/newswarm-lab/new-bee). View at [docs.ethswarm.org](https://docs.ethswarm.org).
...
1. Get the OpenAPI YAML source files from which the documentation is generated. They can be found in the [openapi folder of bee repo](https://github.com/newswarm-lab/new-bee/tree/master/openapi).
