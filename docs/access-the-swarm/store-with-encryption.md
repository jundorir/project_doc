...
In New-Swarm, all data is *public* by default. To protect sensitive content, it must be encrypted so that only authorised users are able to decrypt and then view the plaintext content. 
...
```bash
curl -F file=@bee.jpg -H "Swarm-Encrypt: true" http://localhost:11633/files
```
...
:::info
Encryption is disabled by default on all New-Swarm Gateways to keep your data safe. [Install Bee on your computer](/docs/installation/quick-start) to use the encryption feature.
:::
...
```bash
curl -OJ http://localhost:11633/files/f7b1a45b70ee91d3dbfd98a2a692387f24db7279a9c96c447409e9205cf265baef29bf6aa294264762e33f6a18318562c86383dd8bfea2cec14fae08a8039bf3
```
