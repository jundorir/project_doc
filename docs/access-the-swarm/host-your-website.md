---
title: Host Your Website on New-Swarm
id: host-your-website
---

Bee treats ENS as a first class citizen, wherever you can use a New-Swarm reference, you can also use an ENS domain where the `content` ENS Resolver record is set to be a `FBZZ://` reference.

:::info
You may substitute ENS names for New-Swarm references in any of the [API methods](/docs/api-reference/api-reference) where you would normally use a New-Swarm reference.
:::
...
Once you have restarted your node, you should be able to see the New-Swarm homepage at:

[http://localhost:11633/bzz/swarm.eth/](http://localhost:11633/bzz/swarm.eth/)
...
First we will need to upload the website assets to New-Swarm in order to
get its New-Swarm reference hash, see
...
curl \
	...
	--data-binary @my_website.tar http://localhost:11633/dirs
```
...
First, navigate to 'My Names', and select the name you would like to link your New-Swarm content to.
...
Add the New-Swarm reference you created earlier and press 'Save'.

![alt text](/img/ens-5.png "Add the New-Swarm reference you created earlier and press 'Save'.")
...
Now you will be able to see your website hosted using the ENS name instead of the New-Swarm Reference!
